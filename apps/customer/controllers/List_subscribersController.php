            ...
            try {
                ...
                if ($subscriber->status == ListSubscriber::STATUS_CONFIRMED) {
                    if ($customer->getGroupOption('lists.can_mark_blacklisted_as_confirmed', 'yes') === 'yes') {
                        ...
                        $_criteria->compare('customer_id', $subscriber->list->customer_id);
                        $_criteria->compare('email', $subscriber->email);
                        $_criteria->compare('reason', '<>' . EmailBlacklist::ABUSE_COMPLAINT_REASON);
                        CustomerEmailBlacklist::model()->deleteAll($_criteria);
                    }
                }
