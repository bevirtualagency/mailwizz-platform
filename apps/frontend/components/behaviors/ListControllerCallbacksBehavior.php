...
class ListControllerCallbacksBehavior extends CBehavior
{
     ...
     * @return void
     */
    public function handleUnsubscribeAfterValidateSendEmailFail(Lists $list): void
    {
     ...
     * @return void
     */
    public function handleSendSubscribeConfirmationEmailFailed(Lists $list)
    {
        /** @var OptionUrl $optionUrl */
        $optionUrl = container()->get(OptionUrl::class);
     ...
     * @return void
     */
    public function handleUpdateProfileSendEmailFail(Lists $list): void
    {
        /** @var OptionUrl $optionUrl */
        $optionUrl = container()->get(OptionUrl::class);

        $messageTitle   = 'Unable to send email';
        $messageContent = 'Sending the update profile email for a subscriber belonging to the {list} list failed because the system was not able to find a suitable delivery server to send the email';
